...
urlpatterns = [
    # Ajax Requests
    path('delete-bookmark-item/', views.delete_bookmark_item,
         name='delete_bookmark_item'),

    path('sign-in-or-register/', views.sign_in_or_register, name='signup_login'),
    path('profile/<slug:user_first_name>/<int:user_id>/',
         views.profile, name='profile'),
    path('instructor-profile/<slug:user_first_name>/<int:user_id>/',
    ...
    path('awaiting-activation/', views.awaiting_activation,
    ...
    path('courses/instructor/content/',
         views.create_content, name='create_content'),
    path('courses/admin/drafts/', views.admin_draft_view, name='drafts'),
    path('courses/instructor/drafts/',
         views.instructor_drafts, name='instructor_drafts'),
]
