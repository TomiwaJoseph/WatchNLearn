...
urlpatterns = [
    ...
    path('courses/category/<slug:category>/', views.get_category_courses, name='course_filter'),
    path('course/<slug:obj>/<slug:module_slug>/<slug:content_id>/', views.view_content, name='play_content'),
    path('courses/review/', views.save_review, name='save_review'),
    path('course/buy-now/<slug:course>/', views.confirm_buy, name='confirm_buy'),
